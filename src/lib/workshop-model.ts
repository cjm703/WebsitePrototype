...
export const STARTER_WORKSHOP_COMPONENTS: WorkshopComponent[] = [
  ...
  component("component-pistol-frame", "Standard Pistol Frame", "Firearm Frame", 300, true, ["9mm", "pistol"], [effect("frame-accuracy", "Balanced Frame", "stat", "Accuracy", 1, "+1 Accuracy", true)]),
  component("component-revolver-frame", "Standard Revolver Frame", "Firearm Frame", 360, true, ["revolver", "handgun", ".357", "frame:revolver"], [effect("revolver-frame-rule", "Revolver Configuration", "rule", "", 0, "Configures the weapon as a durable cylinder-fed revolver.", true)]),
  component("component-shotgun-frame", "Standard Shotgun Frame", "Firearm Frame", 550, true, ["shotgun", "12-gauge", "frame:shotgun"], [effect("shotgun-frame-rule", "Shotgun Configuration", "rule", "", 0, "Configures the weapon as a close-range shotgun platform.", true)]),
  component("component-rifle-frame", "Standard Rifle Frame", "Firearm Frame", 650, true, ["rifle", "longarm", "frame:rifle"], [effect("rifle-frame-rule", "Rifle Configuration", "rule", "", 0, "Configures the weapon as a stable long-range rifle platform.", true)]),
  component("component-automatic-frame", "Standard Automatic Frame", "Firearm Frame", 800, true, ["automatic", "carbine", "rifle", "frame:automatic"], [effect("automatic-frame-rule", "Automatic Configuration", "rule", "", 0, "Configures the weapon as a magazine-fed automatic carbine.", true)]),
  ...
  component("component-suppressor", "Sound Suppressor", "Muzzle Attachment", 320, true, ["muzzle", "9mm"], [effect("suppressor-rule", "Suppressed", "rule", "", 0, "Greatly reduces the sound of firing.", true)]),
];
