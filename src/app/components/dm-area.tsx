...
import type {
  PlayerStats, PlayerData, TagDefinition,
        ...
        <div className="flex gap-2 mb-6 flex-wrap">
          {sections.map((s) => {
            ...
            return (
              <button
                key={s.id}
                onClick={async () => { setActiveSection(s.id); setEditingPlayer(null); setIsAddingNewPlayer(false); setEditingInfo(null); setIsAddingNewInfo(false); setEditingNotif(null); setIsAddingNewNotif(false); }}
